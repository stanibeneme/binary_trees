...
/**
 * binary_trees_ancestor - this finds lowest common ancestor of two nodes
 * @first: pointer to the first node to find ancestor
 * @second: pointer to second node to find the ancestor
 *
